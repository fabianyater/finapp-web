...
function AccountMenu({
  ...
  return (
    <div ref={ref} className="relative min-w-0">
      ...
      {open && (
        <div className="absolute left-0 top-12 z-40 w-[min(20rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-gray-200 bg-white p-1.5 shadow-2xl dark:border-[#2a2a28] dark:bg-[#1a1a18]">
          ...
          <Link
            ...
            className="mt-1 flex h-9 items-center justify-center gap-1.5 rounded-xl border border-dashed border-gray-200 text-xs font-semibold text-gray-500 transition-colors hover:border-emerald-300 hover:text-emerald-600 dark:border-[#3a3a38] dark:text-gray-400"
          >
            <Plus size={13} />
            Gestionar cuentas
          </Link>
