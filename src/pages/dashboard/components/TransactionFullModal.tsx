...
import { fmt, fmtDate, fmtDateFull } from "../utils/formatters";
...
export default function TransactionFullModal({
  ...
  const filteredCats = categories.filter((c) => c.type === txTypeFilter === "ALL" ? undefined : (txTypeFilter === "EXPENSE" ? "EXPENSE" : "INCOME"));
